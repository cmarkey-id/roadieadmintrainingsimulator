...
Release 2 Epic 1.21 update:
- Adds a self-directed Practice Library with all five scenarios available in any order.
- Adds topic and difficulty filters, completion history, and repeat-practice controls.
- Keeps the original ordered Full Shift Simulation available as a separate mode.

Release 2 Epic 1.22 update:
- Expands Scenarios 2-5 with case-specific investigation records and action sequences.
- Adds workflow-specific checklists, validation, documentation, scoring, and coaching.
- Uses the six-mile corrected-address path with POD, manual delivery, and a $6 credit.
