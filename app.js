...
function openCoach(){
  const d=$('#coachDialog');
  $('#coachTitle').textContent='Meet Waffles';
  $('#coachIntro').textContent='Hi! I’m Waffles, your Training Coach. I’m here to help you build confidence while you practice. I can offer hints, help you think through the next step, and encourage you along the way. You’ll make the decisions and work the case yourself.';
  $('#coachCases').textContent=`${state.casesCompleted} / ${CASE_LIBRARY.length}`;
